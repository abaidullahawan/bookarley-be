            ...
            <Col lg={12}>
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <Badge variant="primary" className="mt-2 mr-2">
                    Primary
                  </Badge>
                  <Badge variant="secondary" className="mt-2 mr-2">
                    Secondary
                  </Badge>
                  <Badge variant="success" className="mt-2 mr-2">
                    Success
                  </Badge>
                  <Badge variant="danger" className="mt-2 mr-2">
                    Danger
                  </Badge>
                  <Badge variant="warning" className="mt-2 mr-2">
                    Warning
                  </Badge>
                  <Badge variant="info" className="mt-2 mr-2">
                    Info
                  </Badge>
                  <Badge variant="light" className="mt-2 mr-2">
                    Light
                  </Badge>
                  <Badge variant="dark" className="mt-2 mr-2">
                    Dark
                  </Badge>
                </div>
              </div>
