              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ButtonToolbar>
                    ...
                    <Button variant="warning" className="mt-2 mr-2">
                      Warning
                    </Button>
                    <Button variant="danger" className="mt-2 mr-2">
                      Danger
                    </Button>
                    <Button variant="info" className="mt-2 mr-2">
                      Info
                    </Button>
                    <Button variant="light" className="mt-2 mr-2">
                      Light
                    </Button>
                    <Button variant="dark" className="mt-2 mr-2">
                      Dark
                    </Button>
                    <Button variant="link" className="mt-2 mr-2">
                      Link
                    </Button>
                  </ButtonToolbar>
                </div>
            ...
            <Col lg={12}>
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ButtonToolbar>
                    <Button variant="primary" className="rounded mt-2 mr-2">
                      Primary
                    </Button>
                    <Button variant="secondary" className="rounded mt-2 mr-2">
                      Secondary
                    </Button>
                    <Button variant="success" className="rounded mt-2 mr-2">
                      Success
                    </Button>
                    <Button variant="warning" className="rounded mt-2 mr-2">
                      Warning
                    </Button>
                    <Button variant="danger" className="rounded mt-2 mr-2">
                      Danger
                    </Button>
                    <Button variant="info" className="rounded mt-2 mr-2">
                      Info
                    </Button>
                    <Button variant="light" className="rounded mt-2 mr-2">
                      Light
                    </Button>
                    <Button variant="dark" className="rounded mt-2 mr-2">
                      Dark
                    </Button>
                    <Button variant="link" className="rounded mt-2 mr-2">
                      Link
                    </Button>
                  </ButtonToolbar>
                </div>
              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ButtonToolbar>
                    ...
                    <Button variant="outline-light" className="mt-2 mr-2">
                      Light
                    </Button>
                    <Button variant="outline-dark" className="mt-2 mr-2">
                      Dark
                    </Button>
                  </ButtonToolbar>
                </div>
