              ...
              <div className="notifications-card mb-4">
                ...
                <ListGroup>
                  ...
                  <ListGroup.Item>
                    ...
                    <div className="pr-70">
                      <Link to="#">Mitch</Link> & <Link to="#">2 others</Link>{" "}
                      followed you.
                  ...
                  <ListGroup.Item>
                    ...
                    <div className="pr-70">
                      <Link to="#">Philip Satemburgo</Link> &{" "}
                      <Link to="#">2 others</Link> quit his job.
                      <div className="time">4 min ago</div>
                    </div>
                  </ListGroup.Item>
                </ListGroup>
                ...
                <div className="card-body">
                  <div className="notification-card-two text-center">
                    ...
                    <p className="mt-1 mb-1 mw-350">
                      Just sent a new comment! Lorem Ipsum is simply dummy text
                      of the.
                    </p>
                    <span className="gray-color">0 seconds ago</span>
                  </div>
