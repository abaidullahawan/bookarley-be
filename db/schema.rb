...
ActiveRecord::Schema[7.0].define(version: 2023_09_14_065249) do
  ...
  create_table "invitation_card_categories", force: :cascade do |t|
    t.bigint "invitation_category_id"
    t.bigint "invitation_card_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["invitation_card_id"], name: "index_invitation_card_categories_on_invitation_card_id"
    t.index ["invitation_category_id"], name: "index_invitation_card_categories_on_invitation_category_id"
  end

  create_table "invitation_cards", force: :cascade do |t|
    t.string "card_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "canvas_data"
  ...
  create_table "spree_blog_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "blog_overview"
  end

  create_table "spree_blog_replies", force: :cascade do |t|
    t.string "name"
    t.text "comment"
    t.bigint "spree_blog_reviews_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["spree_blog_reviews_id"], name: "index_spree_blog_replies_on_spree_blog_reviews_id"
  end

  create_table "spree_blog_reviews", force: :cascade do |t|
    t.string "name"
    t.string "city"
    t.text "comment"
    t.bigint "spree_blog_post_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "rating"
    t.string "bg_color"
    t.index ["spree_blog_post_id"], name: "index_spree_blog_reviews_on_spree_blog_post_id"
  end
